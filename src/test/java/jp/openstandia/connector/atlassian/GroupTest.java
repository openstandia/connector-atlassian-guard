...
class GroupTest extends AbstractTest {
    ...
    void addGroup() {
        ...
        AtomicReference<AtlassianGuardGroupModel> created = new AtomicReference<>();
        ...
        AtlassianGuardGroupModel newGroup = created.get();
    ...
    void getGroupByUid() {
        ...
        mockClient.getGroupByUid = ((u) -> {
            ...
            AtlassianGuardGroupModel result = new AtlassianGuardGroupModel();
            result.id = currentId;
            ...
            member.type = "User";
            member.ref = "https://example.com/scim/directory/test/Users/" + currentMember1;
            result.members.add(member);
            result.meta = new AtlassianGuardGroupModel.Meta();
    ...
    void getGroupsTwo() {
        ...
        mockClient.getGroups = ((h, size, offset) -> {
            ...
            result = new AtlassianGuardGroupModel();
            result.id = "2";
    ...
    void getGroupsByMembers() {
        ...
        mockClient.getGroups = ((h, size, offset) -> {
            ...
            member.type = "User";
            member.ref = "https://example.com/scim/directory/test/Users/user001";
            result.members.add(member);

            member = new AtlassianGuardGroupModel.Member();
            member.value = "user002";
            member.type = "User";
            member.ref = "https://example.com/scim/directory/test/Users/user002";
            result.members.add(member);

            member = new AtlassianGuardGroupModel.Member();
            member.value = "user003";
            member.type = "User";
            member.ref = "https://example.com/scim/directory/test/Users/user003";
            result.members.add(member);
