...
class SchemaTest extends AbstractTest {
    ...
    void user() {
        ...
        assertEquals(20, attributeInfo.size());
        ...
        assertAttributeInfo(attributeInfo, "name.middleName");
        assertAttributeInfo(attributeInfo, "name.honorificPrefix");
        assertAttributeInfo(attributeInfo, "name.honorificSuffix");
        assertAttributeInfo(attributeInfo, "displayName");
        assertAttributeInfo(attributeInfo, "nickName");
        assertAttributeInfo(attributeInfo, "title");
        assertAttributeInfo(attributeInfo, "preferredLanguage");
        assertAttributeInfo(attributeInfo, "timezone");
        assertAttributeInfo(attributeInfo, OperationalAttributes.ENABLE_NAME);
        assertAttributeInfo(attributeInfo, "primaryEmail");
        assertAttributeInfo(attributeInfo, "primaryPhoneNumber");
