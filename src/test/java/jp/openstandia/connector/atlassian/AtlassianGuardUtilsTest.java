...
class AtlassianGuardUtilsTest {
    ...
    void createFullAttributesToGet() {
        SchemaDefinition.Builder<AtlassianGuardUserModel, AtlassianGuardUserModel, AtlassianGuardUserModel> builder = SchemaDefinition.newBuilder(AtlassianGuardUserHandler.USER_OBJECT_CLASS, AtlassianGuardUserModel.class, AtlassianGuardUserModel.class);
